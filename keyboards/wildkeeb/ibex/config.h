...
#define VENDOR_ID       0x776b // "wk" in ASCII
#define PRODUCT_ID      0x0001 // First keyboard from WildKeeb
...
#define MATRIX_COL_PINS { A6, A7, C1, B0, B1, B2, B3, B4, D0, D1, C2, C3, D4, D5, D6, D7 }
#define UNUSED_PINS
